...
<body style="background-color: #D0E7D2" ;>
    ...
    <div class="container pt-4 table-responsive">
        <h3 class="text-center fw-bold pb-3">DAFTAR PENDAKI GUNUNG</h3>
        <table class=" table table-hover text-center" data-aos="fade-down">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row->asaldaerah ?></td>
                    <td><?php echo $row->jeniskelamin ?></td>
                    <td><?php echo $row->namagunung ?></td>
                    <td><?php echo $row->tglnaik ?></td>
                    <td><?php echo $row->tglturun ?></td>
                </tr>
            <?php
            }
            ?>
