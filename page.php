...
<body style="background-color: #D0E7D2";>
    ...
    <div class="container">
    <?php 
        $hasil = mysqli_query($db, "SELECT * FROM berita WHERE id='$_GET[id]'"); 
        ...
        <div class="pt-5">
            <div>
                <center>
                <img class="img-fluid pb-5" src="<?= $row->photo ?>">
                </center>
                
                <h4 align="justify" ><?= $row->judul ?></h4>
                <p align="justify"><?= $row->deskripsi?>
            </div>
            <?php
        }
        ?>
